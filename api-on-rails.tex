...
\chapter{Produits des utilisateurs}\label{chapter:6}
  ...
  \section{Le modèle du produit}
    ...
    \subsection{Les foncdements du produit}
      ...
      \begin{scriptsize}
        \begin{lstlisting}[language=bash]
        $ rspec spec/modes/product_spec.rb
        \end{lstlisting}
      \end{scriptsize}
      ...
      Maintenant, chaque produit que nous créons ressemblera un peu plus à un vrai produit. Nous devons encore travailler sur le \verb|user_id| tel quel, mais nous y reviendrons à la section 6.1.3.
