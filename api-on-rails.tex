...
\chapter{Authentification des utilisateurs}\label{chapter:5}
  ...
  \section{Autoriser les actions}
    ...
    \begin{scriptsize}
      \begin{lstlisting}[language=ruby, caption={Utilisation de la méthode before_action pour le controlleur des utilisateurs}, label={lst:add_before_action_to_users}]
      # app/controllers/api/v1/users_controller.rb
      class Api::V1::UsersController < ApplicationController
    ...
    \textit{Comitons} juste ça:

    % http://apionrails.icalialabs.com/book/chapter_five#_code-users_controller_authenticate
