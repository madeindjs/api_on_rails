...
Uma das partes mais doloridas para quase todo desenvolvedor é configurar tudo, mas contanto que você consiga fazer isso, os próximos passos devem ser muito fáceis e recompensadores. Então eu irei guiar você para mantê-lo motivado.
