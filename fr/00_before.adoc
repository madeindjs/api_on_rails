...
Tout le code source de ce livre est disponible au format https://fr.wikipedia.org/wiki/Markdown[Markdown] sur https://github.com/madeindjs/api_on_rails[Github]. Ainsi n’hesitez pas à https://github.com/madeindjs/api_on_rails/fork[forker] le projet si vous voulez l’améliorer ou corrigé une faute qui m’aurais échappé.

=== Droits d’auteur et licence

Cette traduction est disponible sous http://opensource.org/licenses/MIT[licence MIT]. Tout le code source de ce livre est disponible au format https://fr.wikipedia.org/wiki/Markdown[Markdown] sur https://github.com/madeindjs/api_on_rails[Github]
