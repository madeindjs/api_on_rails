...
We are at the end of our chapter. It is therefore time to apply all our modifications to the master branch by making a `merge`. To do this, we place ourselves on the `master` branch and we _merge_ `chapter02`:
