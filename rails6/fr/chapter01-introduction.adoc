...
- Tester vos points d'entrée avec des tests unitaires et fonctionnels
...
Dans ce tutoriel, nous allons utiliser RVM mais peu importe laquelle de ces deux options que vous utiliserez.
