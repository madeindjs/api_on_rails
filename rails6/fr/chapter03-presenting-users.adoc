...
Nous allons modifier un petit cette migration afin d'ajouter quelques validations côté base de données. Avec Rails il est d'usage de faire ces vérfications directement dans le modèle Ruby mais c'est une bonne pratique de le faire aussi dans le schéma de la base de données.
