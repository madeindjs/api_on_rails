...
Une fois la commande exécuté, la ligne suivante est ajoutée à la fin du _Gemfile_:
...
Nous pouvons aussi d'envoyer un attribut `password_confirmation` qui ne correspond pas à `password`:
...
Finished in 0.162936s, 24.5496 runs/s, 30.6869 assertions/s.
...
Finished in 0.172159s, 34.8516 runs/s, 52.2774 assertions/s.
...
Finished in 0.163526s, 48.9220 runs/s, 67.2677 assertions/s.
...
----
$ rails test
Running via Spring preloader in process 22051
Run options: --seed 9630

# Running:

.........

Finished in 0.288557s, 31.1897 runs/s, 45.0518 assertions/s.
