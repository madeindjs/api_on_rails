...
Cela possède beaucoup d'avantages comme par exemple envoyer des informations au consomateur de l'API direction dans le token. On pourra par exemple choisir d'intégrer les informations de l'utilisateur dans le _payload_.
