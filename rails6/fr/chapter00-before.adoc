...
Dans cette version je n'ai pas seulement cherché à rendre les exemples compatible mais j'ai aussi voulu simplifier la mise en place d'une API avec Rails en utilisant des librairies plus récentes et surtout: maintenues.
